...
#line 1 "/home/mzhang/mantaflow/source/gui/particlepainter.cpp"
/******************************************************************************
 *
...
void ParticlePainter::processKeyEvent(PainterEvent e, int param) {
    cout<<"ParticlePainter::processKeyEvent"<<endl;
...
void ParticlePainter::updateText() {
    ...
    if (mObject && !mHide) {
        s <<"ParticlePainter "<< mLocal->infoString() << endl;
    }
...
void ParticlePainter::paint() {
    ...
    if(to_debug)
    cout<<"sheldon's comments ParticlePainter::paint() "<<mLocal->getType()<<"   "<<mLocal->infoString()<<endl;
    ...
    if(to_debug)
        cout<<"sheldon's comments drawing Filament"<<endl;
    ...
    if(to_debug)
        cout<<"sheldon's comments drawing PARTICLE"<<endl;
